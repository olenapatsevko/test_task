...
public interface EmployeeDao extends CrudRepository<Employee, Long> {
    ...
    @Query(
            value = "SELECT a.id as id , a.name as name , a.salary as salary , a.boss_id as boss_id, a.department_id FROM employee AS a " +
                    "WHERE a.salary IN (" +
    ...
    @Query(
            value = "SELECT a.id as id , a.name as name , a.salary as salary , a.boss_id as boss_id, a.department_id as department_id FROM employee AS a" +
